...
python ./desafio_iafront/jobs/graphics/job_graphics.py --dataframe-path $results/escalados/$scaler --x_axis longitude  --y_axis latitude --cluster_label convertido --data-inicial $data_inicial --data-final $data_final --saida mapa_convertidos.html
python ./desafio_iafront/jobs/graphics/job_histogram.py --dataframe-path $results/escalados/$scaler --axe frete  --bins $bins --data-inicial $data_inicial --data-final $data_final --saida histograma_frete.html
...
python ./desafio_iafront/jobs/graphics/job_dash.py --dataframe-path $results/escalados --data-inicial $data_inicial --data-final $data_final --dash-type $dash_type --saida dash_scatter.html --scaler $scaler --cluster-label convertido
python ./desafio_iafront/jobs/graphics/job_dash.py --dataframe-path $results/escalados --data-inicial $data_inicial --data-final $data_final --dash-type $dash_type2 --saida dash_hist.html --bins $bins --scaler $scaler --cluster-label convertido

echo "==> Run job to see dash of clusterized scatter atribute combinations"
python ./desafio_iafront/jobs/graphics/job_dash.py --dataframe-path $results/clusters/$cluster_method --data-inicial $data_inicial --data-final $data_final --dash-type $dash_type --saida dash_scatter_cluster.html --scaler $scaler --cluster-label cluster_label
...
python ./desafio_iafront/jobs/graphics/job_clust_map.py --dataframe-path $results/clusters --data-inicial $data_inicial --data-final $data_final --dash-type $dash_type --saida map_scatter_cluster.html --scaler $scaler --cluster-method $cluster_method
...
python ./desafio_iafront/jobs/graphics/job_convert.py --dataframe-path $results/clusters --data-inicial $data_inicial --data-final $data_final --saida total_conversion.html --cluster-method $cluster_method --scaler $scaler
...
python ./desafio_iafront/jobs/graphics/job_series.py --dataframe-path $results/clusters --data-inicial $data_inicial --data-final $data_final --saida serie_timescale_dia.html --cluster-method $cluster_method --scaler $scaler --timescale $timescale
